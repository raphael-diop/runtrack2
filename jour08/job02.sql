...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : mer. 10 nov. 2021 à 12:12
...
CREATE TABLE IF NOT EXISTS `etage` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='table salle';
...
CREATE TABLE IF NOT EXISTS `etudiants` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=15 DEFAULT CHARSET=latin1 COMMENT='table etudiant';
